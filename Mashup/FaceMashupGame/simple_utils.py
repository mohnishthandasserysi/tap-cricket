...
class SimpleMashupGenerator:
    def __init__(self, players_folder: str = "players"):
        """Initialize the simple mashup generator."""
...
def test_simple_face_processing():
    """Test function for simple face processing."""
    try:
        processor = SimpleFaceProcessor()
        print("✅ Simple face processor initialized successfully!")
        
        mashup_gen = SimpleMashupGenerator()
        print("✅ Simple mashup generator initialized successfully!")
